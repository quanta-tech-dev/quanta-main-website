...
const HeaderButtons: React.FC<LangButtonProps> = () => {
  return (
    <div className="hidden lg:flex items-center gap-2">
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-[#098FD7] to-[#025a87] rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10"></div>
      </a>
