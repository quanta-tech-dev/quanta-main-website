                                    ...
                                    <div
                                        ...
                                        <article
                                            ...
                                            <h3 className="mt-3 text-base text-left font-semibold leading-6 text-white">
                                                <a href="#"
                                                   className={"hover:text-blue-400 transition-colors duration-300"}><span
                                                    className="absolute inset-0"></span>The
                                                    Rise of
                                                ...
                                                <div className="-ml-4 flex items-center gap-x-4">
                                                    ...
                                                    <div className="flex gap-x-2.5 author-img">
                                                        <Image
                                                            ...
                                                            width={500}
                                                            height={500}
                                                            className="h-6 w-6 flex-none rounded-full bg-white/10"/>Michael
                                                    </div>
                                                </div>
                                            </div>
                                            <h3 className="mt-3 text-base text-left font-semibold leading-6 text-white">
                                ...
                                <div className="flex flex-col relative sm:items-start">
                                    ...
                                    <div
                                        ...
                                        <article
                                            ...
                                            <h3 className="mt-3 text-base text-left font-semibold leading-6 text-white">
                                                <a href="#"
                                                   className="text-white hover:text-blue-400 transition-colors duration-300"><span
                                                    className="absolute inset-0"></span>The
                                                    Rise of
                                                    Blockchain Technology:
                                                    A Comprehensive Guide</a>
